...
class Apka(Frame):
    """Aplikacja  z GUI służąca do wyboru ulubionych gatunków filmowych"""
    ...
    def create_widgets(self):
        """Utwórz widgety słu.żące do wyboru gatunków filmowych"""
        # utwórz etykietę z opisem
        Label(self, text = "Wybierz swoje ulubione gatunki filmowe").grid(row = 0, column = 0, sticky = W)
        # utwórz etykietę z instrukcją
        Label(self, text = "Zaznacz wszystkie, które chciałbyś wybrać: ").grid(row = 1, column = 0, sticky = W)
