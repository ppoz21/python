...
def image_list(request):
    ...
    try:
        ...
        # Jeżeli zmienna nie jesli liczbą całkowitą, pobieramy 1 stronę wyników
        images = paginator.page(1)
    except EmptyPage:
        if request.is_ajax():
            # Jeżeli żądanie jest w technologii AJAX i zmienna page jest spoza zakresu, wówczas zwracana jest pusta strona
            return HttpResponse('')
        #Jeżeli zmienna page ma wartość więksżą niż numer ostatniej strony wyników, wtedy pobierana jest ostatnia strona wyników
